/*
Deployment script for BookLibraryWPF
...
GO
:setvar DatabaseName "BookLibraryWPF"
:setvar DefaultFilePrefix "BookLibraryWPF"
...
ALTER TABLE [dbo].[BookTracking] WITH NOCHECK
    ADD CONSTRAINT [FK_BookTrackingAccountId] FOREIGN KEY ([AccountId]) REFERENCES [dbo].[Accounts] ([ID]) ON UPDATE CASCADE;
